...
const crops: Crop[] = [
  ...
  { id: '8', nombre: 'Sacha Inchi', region: 'Amazonía', clima: 'Húmedo', cuidados: 'Es una enredadera que necesita soporte para crecer adecuadamente.', temporada: 'Todo el año', imageUrl: 'https://images.pexels.com/photos/1203803/pexels-photo-1203803.jpeg', dataAiHint: 'sacha inchi' },

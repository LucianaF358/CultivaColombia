...
const ColombiaSVG = ({ selectedRegion, onRegionClick }: { selectedRegion: string | null, onRegionClick: (region: string) => void }) => {
    // Simplified SVG paths for Colombian regions
    const regionPaths: { [key: string]: string } = {
        'Andina': "M159.5 178.5L163 171L173.5 157L178 148L183.5 137.5L189.5 125L194.5 110L196 96L202 89L208.5 76.5L203 69.5L194 62L189 50L186.5 40L178 33.5L171 30.5L166 22.5L159.5 18L150 20L142 24.5L138 33L135 44L127.5 54.5L120.5 66.5L113.5 82.5L110 94L105.5 110L103 122.5L98 136L93.5 147.5L93.5 158L97.5 168L103.5 175.5L110.5 180L121 185.5L130 187L141.5 185.5L150 182.5L159.5 178.5Z",
        'Caribe': "M208.5 76.5L214.5 75L224.5 71L234.5 65.5L245 57.5L255.5 49L265 42.5L271.5 35L273.5 25.5L263.5 20.5L250 17L235 15.5L220.5 17.5L211.5 24L200.5 30L194 36.5L186.5 40L189 50L194 62L203 69.5L208.5 76.5Z",
        'Pacífica': "M110 94L105.5 110L103 122.5L98 136L93.5 147.5L93.5 158L85.5 156L78 149L72 137.5L68 126L65 115L64.5 102.5L68 90.5L74.5 82L82.5 77L90 77.5L98 81.5L104.5 88L110 94Z",
        'Orinoquía': "M178 148L173.5 157L163 171L159.5 178.5L150 182.5L141.5 185.5L152 195L163.5 204L175.5 210.5L189 216L201 220.5L213.5 221L224 216L230.5 209.5L234.5 201L235.5 190.5L232.5 179.5L226 169.5L217.5 161.5L209 154L199.5 150.5L189.5 150L178 148Z",
        'Amazonía': "M93.5 158L97.5 168L103.5 175.5L110.5 180L121 185.5L130 187L141.5 185.5L152 195L163.5 204L175.5 210.5L189 216L201 220.5L213.5 221L212 231.5L204.5 240L193.5 248.5L181.5 254.5L168.5 259L154.5 260.5L141 259.5L128 255.5L116 249.5L106.5 241L99.5 231L95 220L92.5 208L92 195.5L90.5 182.5L90.5 169L93.5 158Z"
    };

    return (
        <svg viewBox="0 0 300 280" className="w-full h-auto max-h-[400px] drop-shadow-lg">
            <g>

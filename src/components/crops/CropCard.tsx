...
export function CropCard({ crop, isFavorite }: CropCardProps) {
  return (
    <Card className="flex flex-col h-full overflow-hidden hover:shadow-xl transition-shadow duration-300 bg-card">
      ...
      <CardHeader>
        <CardTitle className="font-headline text-2xl text-primary">{crop.nombre}</CardTitle>
        <CardDescription>{crop.cuidados}</CardDescription>
      </CardHeader>
